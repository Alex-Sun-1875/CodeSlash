...
- 温度: ${config.temperature}
    ...
    const addImportCommand = vscode.commands.registerCommand('code-slash.addImport', async (importStatement: string) => {
        const editor = vscode.window.activeTextEditor;
    ...
    const generateDocsCommand = vscode.commands.registerCommand('code-slash.generateDocs', async () => {
        const editor = vscode.window.activeTextEditor;
        if (!editor) return;
    ...
    const refactorCommand = vscode.commands.registerCommand('code-slash.refactor', async () => {
        ...
        try {
            const suggestions = await aiService.generateRefactoringSuggestion(selection, 'Improve this code');
    ...
    const enableInlineCompletionCommand = vscode.commands.registerCommand('code-slash.enableInlineCompletion', async () => {
    ...
    const disableInlineCompletionCommand = vscode.commands.registerCommand('code-slash.disableInlineCompletion', async () => {
    ...
    const acceptInlineCompletionCommand = vscode.commands.registerCommand('code-slash.acceptInlineCompletion', async () => {
